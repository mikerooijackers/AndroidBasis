...
public class MyTodoContentProvider extends ContentProvider {
	...
	public static final String SUMMARY = TodoTable.COLUMN_SUMMARY;
	public static final String DESCRIPTION = TodoTable.COLUMN_DESCRIPTION;
	public static final String CATEGORY = TodoTable.COLUMN_CATEGORY;
	
	// database
	private TodoDatabaseHelper database;

	// Used for the UriMacher
	private static final int TODOS_URI_TYPE = 10;
	private static final int TODO_URI_TYPE = 20;
	
	private static final UriMatcher sURIMatcher = new UriMatcher(UriMatcher.NO_MATCH);
	
	static {
		sURIMatcher.addURI(AUTHORITY, BASE_PATH, TODOS_URI_TYPE);
		sURIMatcher.addURI(AUTHORITY, BASE_PATH + "/#", TODO_URI_TYPE);
	}
